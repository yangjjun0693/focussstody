 ...
 * Supabase redirects to Google, then back to login.html?code=...
 * The supabase client auto-handles the code exchange on page load.
 */
...
/**
 * After a Google OAuth redirect, exchange the code for a session.
 * Supabase JS v2 does this automatically on createClient,
 * but we expose this helper to explicitly check + handle new Google users.
 * Returns { session, isNewUser } or null.
 */
export async function handleOAuthCallback() {
    // supabase auto-exchanges the code; just get the session
